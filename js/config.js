...
export const CONFIG_SCHEMA = {
  ...
  PALETTE_A: { default: 0, min: 0, max: 2, type: 'int', label: 'Palette A', layerParam: true },
  PALETTE_B: { default: 1, min: 0, max: 2, type: 'int', label: 'Palette B', layerParam: true },
  MASK_PALETTE: { default: 6, min: 3, max: 10, type: 'int', label: 'Mask Palette', layerParam: true },
  SPLIT_PALETTE:         { default: false, type: 'bool', label: 'Split Palette', layerParam: true },
  SPLIT_AXIS: { default: 0, min: 0, max: 1, type: 'int', label: 'Split Axis', layerParam: true },
  ...
  CURL_FADE_SMOOTHNESS: { default: 0.5, min: 0, max: 1, step: 0.01, label: 'Curl Fade Smoothness', layerParam: true },
  CURL_FADE_AXIS: { default: 0, min: 0, max: 1, step: 0.01, label: 'Curl Fade Axis', layerParam: true },
  CURL_FADE_VALUE: { default: 1.0, min: 0, max: 1, step: 0.01, label: 'Curl Fade Value', layerParam: true },
