...
export const CONFIG_SCHEMA = {
  ...
  PALETTE_A: { default: 0, min: 0, max: 2, type: 'int', label: 'Palette A', layerParam: true, randomize: true },
  PALETTE_B: { default: 1, min: 0, max: 2, type: 'int', label: 'Palette B', layerParam: true, randomize: true },
  MASK_PALETTE: { default: 6, min: 3, max: 10, type: 'int', label: 'Mask Palette', layerParam: true, randomize: true },
  SPLIT_PALETTE:         { default: false, type: 'bool', label: 'Split Palette', layerParam: true , randomize: true },
  SPLIT_AXIS: { default: 0, min: 0, max: 1, type: 'int', label: 'Split Axis', layerParam: true, randomize: true },
  SPLIT_SMOOTHNESS: { default: 0.5, min: 0, max: 1, step: 0.01, label: 'Split Smoothness', layerParam: true },
  PALETTE_MIX: { default: 0.0, min: 0, max: 1, step: 0.01, label: 'Palette Mix', layerParam: true , randomize: true},
  ...
  VELOCITYSCALE:      { default: 0.0,  min: 0,   max: 5,  step: 0.01, label: 'Velocity Scale', layerParam: true  , randomize: true},
  DENSITY_DISSIPATION:{ default: 0.25, min: 0,   max: .4,  step: 0.001, label: 'Density Dissipation', layerParam: true },
  VELOCITY_DISSIPATION:{ default: 0.2, min: 0,   max: .4,  step: 0.001, label: 'Velocity Dissipation', layerParam: true , randomize: true },
  PRESSURE:           { default: 0.8,  min: 0,   max: 1,  step: 0.01, label: 'Pressure', layerParam: true , randomize: true },
  PRESSURE_ITERATIONS:{ default: 50,   min: 1,   max: 100, type: 'int', label: 'Pressure Iterations' },
  CURL:               { default: 30,   min: 0,   max: 100, step: 0.1, label: 'Curl Strength', layerParam: true  , randomize: true },
  ...
  WIND_SCALE:         { default: 0.5, min: 0, max: 2, step: 0.001, label: 'Wind Scale', id: 'windScale', layerParam: true , randomize: true },
  WIND_TYPE:          { default: 10, min: 0, max: 11, step: 1, type: 'int', label: 'Wind Type', layerParam: true , randomize: true },

  // -------------------- Simulated Pointer --------------------
  SIM_ENABLE:         { default: false, type: 'bool', label: 'Sim Input' , randomize: true },
  ...
  SIM_FORCE:          { default: 2000, min: 0, max: 10000, step: 10, label: 'Sim Force', randomize: true },
